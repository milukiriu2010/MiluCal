...
class ContextCal(
            ...
            when (it) {
                "!" -> {
                    ...
                    // エラー
                        ...
                        throw CalException(
                            CalException.ErrType.ERR_FMT_FACTORIAL,
                            "the value should be number before factorial mark'!'"
                        )
                    }
                }
                else -> {
        ...
        ite.forEach {
            ...
            when (it) {
                "^" -> {
                    ...
                    if ( prevCalType != CalType.NUM) {
                        throw CalException(
                            CalException.ErrType.ERR_FMT_POWER,
                            "the right side of the operator '^' is something weird"
                        )
                    }
            ...
            when {
                ...
                ( s == "*" ) -> {
                    ...
                    if ( prevCalType == CalType.NUM) {
                        ...
                        throw CalException(
                            CalException.ErrType.ERR_FMT_MULTIPLY,
                            "value should be number before operator'*'"
                        )
                    }
                }
                // 除算
                ( s == "/" ) -> {
                    ...
                    if ( prevCalType == CalType.NUM) {
                        ...
                        throw CalException(
                            CalException.ErrType.ERR_FMT_DIVIDE,
                            "value should be number before operator'/'"
                        )
                    }
                }
                    ...
                    if ( num != null ) {
                        ...
                        // 除算
                            ...
                            if ( num != 0.0.toBigDecimal() ) {
                                ...
                                throw CalException(
                                    CalException.ErrType.ERR_DIVIDE_ZERO,
                                    "divide by 0"
                                )
                            }
                            ite.remove()
                        ...
                        throw CalException(
                            CalException.ErrType.ERR_FMT_MULTIPLY_DIVIDE,
                            "format error for multiple / divide"
                        )
                    }
                }
            }
    ...
    private fun calPlusMinus(): BigDecimal {
        ...
        try {
                ...
                when {
                    ...
                    // 数値 or それ以外
                        ...
                        // 減算
                            ...
                            throw CalException(
                                CalException.ErrType.ERR_NO_OPERAND,
                                "${tokenLst[0]} has no operand."
                            )
                        }
            ...
            throw CalException(
                CalException.ErrType.ERR_FMT_NUMBER,
                "${tokenLst[0]} is not number."
            )
        }
